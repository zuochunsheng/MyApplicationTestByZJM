...
/**
 * authr : edz on 2017/12/22  下午3:29
 * describe ：SharedPreferences 工具类
 * SharedPreferences是无法直接保存 Object, List集合和 Map集合的，需要先将它们转换为字符串，
 * 在保存到SharedPreferences中，取得时候再把对应的字符串转为Object,List集合或者Map集合。
 * 关于Map的读取暂时只实现Map<String,Object>的类型
 * http://blog.csdn.net/a512337862/article/details/73633420
 */
